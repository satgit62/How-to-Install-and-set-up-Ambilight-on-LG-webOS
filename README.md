...
# You can find a current, specially adapted HyperHDR version, in which the necessary separate LUT tables can be installed via the loader, in another guide I have written. There you will also learn how to perform calibration or fine tuning.

You can access the guide at: https://github.com/satgit62/Ultimate-HyperHDR-Ambilight-fine-tuning-experience-for-LG-webOS-with-new-LUT-calibration-.
...
To make the switch to Hyperk LED controllers easier and more understandable, I have written a guide and made it available on GitHub: [How to Hyperk](https://github.com/satgit62/How-to-install-and-set-up-Hyperk-on-ESP-RP-2040-2350)
...
# A current webOS version of Hyperion.NG Release v2.2.0,
...
https://github.com/satgit62/satgit62.github.io/releases/download/v0.2.0-alpha/org.webosbrew.hyperion.ng.loader_0.2.2_Release.2.2.0_all.ipk
